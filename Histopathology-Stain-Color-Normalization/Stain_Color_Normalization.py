...
ddr="/project/umb_kourosh_zarringhalam/saman/HER2/images/TCGA_raw_output_filtered/"+ sample + "_files/20.0/"
ddo="/project/umb_kourosh_zarringhalam/saman/HER2/images/TCGA_raw_output_filtered/" + sample + "_files/23.0/"
print(ddr)
print("this is test")
tf.flags.DEFINE_string('mode', "prediction", "Mode train/ prediction")
tf.flags.DEFINE_string("logs_dir", "./logs_DGMM_HSD_pred/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", ddr, "path to dataset")
tf.flags.DEFINE_string("tmpl_dir", "/project/umb_kourosh_zarringhalam/saman/HER2/images/label_directory/2classes_unannotated_extra/Tiles_random_selected", "path to template image(s)")
tf.flags.DEFINE_string("out_dir", ddo, "path to template image(s)")
